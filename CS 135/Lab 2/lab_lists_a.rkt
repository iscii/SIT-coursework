...
;; 2 PTS
(define (yoda words)
	(cons (car (cdr (cdr words))) (cons (car words) (list (car (cdr words)))))
)
...
(define (quad-roots a b c)
	(define (skrt a b c) (sqrt (- (* b b) (* 4 a c))))
	(list (/ (- (* -1 b) (skrt a b c)) (* 2 a)) (/ (+ (* -1 b) (skrt a b c)) (* 2 a)))
)
...
(define (rotate c)
	(define (reverse c) (append (cdr c) (list (car c))))
	(define (90deg c) (cons (car (reverse c)) (list (* (car (cdr (reverse c))) -1))))
	(cons c (cons (90deg c) (cons (list (90deg (90deg c))) (list (90deg (90deg (90deg c)))))))
)
